...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] == "POST") {
    if (isset($_POST['_incluir']) && $_POST['_incluir'] == "_incluir") {
        ...
        $objControl->updateInfo($_POST['nome_cliente'], $_POST['dominio'], $_POST['data_inicio'], $_POST['camp1'], $_POST['camp2'], $_POST['camp3'], $_POST['camp4'], $_POST['camp5'], $_POST['camp6'], $_POST['camp7'], $_POST['camp8'], $_POST['camp9'], $_POST['camp10'], $_POST['camp11'], $_POST['camp12'], $_POST['camp13'], $_POST['camp14'], $_POST['camp15'], $_POST['camp16'], $_POST['camp17'], $_POST['camp18'], $_POST['camp19'], $_POST['camp20'], $_POST['camp21']);
    }
}
